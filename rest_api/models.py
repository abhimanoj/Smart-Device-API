...
class CreateRoomTable(models.Model):
    ...
    user_login = models.ForeignKey(UserLoginTable, related_name='user_login', on_delete=models.CASCADE, help_text="FK on UserLoginTable")
    create_at = models.DateTimeField(db_column='create_at', default=timezone.now)
    comment   = models.CharField(max_length=500, db_column='comment')
    status    = models.CharField(max_length=100, db_column='status')
    ...
    def __str__(self):
        ...
        table_data['user_login'] = str(self.user_login) 
...
class CreateDeviceTable(models.Model):
    ...
    on_from = models.CharField(max_length=500, db_column='on_from')
    schedule_time_start = models.CharField(max_length=500, db_column='schedule_time_start')
